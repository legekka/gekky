...
module.exports = {
    start: (core) => {
        ...
        core.heartbeat.state = core.discord.bot.guilds.get('281188840084078594').members.get('267741038230110210')._roles.indexOf(role) >= 0;
        core.heartbeat.interval = setInterval(() => {
            if (core.heartbeat.state) {
                ...
                setTimeout(() => {
                    if (core.heartbeat.state == (core.discord.bot.guilds.get('281188840084078594').members.get('267741038230110210')._roles.indexOf(role) >= 0)) {
