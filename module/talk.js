...
module.exports = {
    default: (core, message) => {
        tsun = core.discord.dsettings.getTsun(message.guild ? message.guild.id : message.channel.id);
        cmdpref = core.discord.dsettings.getCmdpref(message.guild ? message.guild.id : message.channel.id);
